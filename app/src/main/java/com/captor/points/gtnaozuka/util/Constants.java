...
public class Constants {
    ...
    public static final String POSITION_MSG = "com.captor.points.gtnaozuka.pointscaptor.POSITION";
    public static final String PHOTOS_MSG = "com.captor.points.gtnaozuka.pointscaptor.PHOTOS";
    public static final String PHOTO_MSG = "com.captor.points.gtnaozuka.pointscaptor.PHOTO";
